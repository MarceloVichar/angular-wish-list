...
### Mobile
https://www.figma.com/proto/vqBcCg0GSWxaErav3fewAn/Untitled?type=design&node-id=0-3&t=xSktH6cZpPEa2Igx-0&scaling=min-zoom&page-id=0%3A1&starting-point-node-id=0%3A3
...
- [x] (Não se aplica) - ID26: O aluno colaborou de maneira efetiva com outros membros do projeto, realizando fusões (merges) e resolução de conflitos de código de forma adequada e alinhada às práticas de desenvolvimento colaborativo.
